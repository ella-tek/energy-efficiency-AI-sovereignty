"""Triad kernel on GPU. a = b + 2c, N = 68,000,000.
"""
...
def main():
    ...
    print(f"OFFICIAL triad run {args.run}  |  {host}  |  N={args.n}  B={args.b}")
    ...
    b = torch.randn(args.b, args.n, device=dev, dtype=dt)
    c = torch.randn(args.b, args.n, device=dev, dtype=dt)
    ...
    rec = {
        ...
        "N": args.n, "B": args.b, "residency": "device_resident", "alpha": 2.0,
